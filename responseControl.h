...
#define PROPORTIONAL_GAIN_TAIL      0.4  // Proportional control gain for tail rotor
#define INTEGRAL_GAIN_MAIN          0.0005  // Integral control gain for main rotor
#define INTEGRAL_GAIN_TAIL          0.00025  // Integral control gain for tail rotor
...
#define OFFSET_DUTY_TAIL                 0 // Helicopter hover duty
